...
//GHK
void I_SDMessageBox(){
	MessageBox(0, "For Online Hi Scoring, it is recommended that you \nchoose a unique player name and password in \nOptions>Player Setup & Options>ScoreDoom Setup", "GZScoreDoom Configuration", 0);
}
