...
#define	RAGE_TICS ( 35 * TICRATE ) //GHK
#define	SPREAD_TICS	( 35 * TICRATE ) //GHK
#define	REFLECTION_TICS	( 35 * TICRATE ) //GHK
...
// ghk Double firing speed rune -------------------------------------------------

IMPLEMENT_STATELESS_ACTOR( APowerDoubleFiringSpeed, Any, -1, 0 )
PROP_Powerup_EffectTics (RAGE_TICS)
PROP_Inventory_Icon ("DEMSE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR( APowerReflection, Any, -1, 0 )
PROP_Powerup_EffectTics (REFLECTION_TICS)
PROP_Inventory_Icon ("SPOTE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR( APowerSpread, Any, -1, 0 )
PROP_Powerup_EffectTics (SPREAD_TICS)
PROP_Inventory_Icon ("AMM1H0") //GHK
END_DEFAULTS
...
// GHK Infinite Ammo Powerup -----------------------------------------------------

IMPLEMENT_STATELESS_ACTOR( APowerInfiniteAmmo, Any, -1, 0 )
PROP_Powerup_EffectTics (20*TICRATE)
PROP_Inventory_Icon ("AMSPE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR (APowerInvulnerable, Any, -1, 0)
	...
	PROP_Inventory_Icon ("PINVE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR (APowerFrightener, Any, -1, 0)
	PROP_Powerup_EffectTics (24*TICRATE) //(60*TICRATE)
	PROP_Inventory_Icon ("PHOBE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR( APowerTimeFreezer, Any, -1, 0 )
	...
	PROP_Inventory_Icon ("GIGAE0") //GHK
END_DEFAULTS
...
void APowerDamage::InitEffect( )
{
	...
	Owner->player->cheats |= CF_POWERDAMAGE; //GHK TEST
}
...
void APowerDamage::EndEffect( )
{
	...
	// Nothing to do if there's no owner.
	if (Owner != NULL && Owner->player != NULL)//ghk conditional added
	{
		Owner->player->cheats &= ~CF_POWERDAMAGE; //ghk
	}
}
...
IMPLEMENT_STATELESS_ACTOR( APowerDrain, Any, -1, 0 )
	...
	PROP_Inventory_Icon ("REGNE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR( APowerGod, Any, -1, 0 )
	PROP_Powerup_EffectTics( 60*TICRATE )
	PROP_Inventory_Icon ("HELSE0") //GHK
END_DEFAULTS
...
IMPLEMENT_STATELESS_ACTOR( APowerRegeneration, Any, -1, 0 )
	...
	PROP_Inventory_Icon ("PROTE0") //GHK
END_DEFAULTS
...
PROP_Powerup_EffectTics (60*TICRATE)
PROP_Inventory_Icon ("HIGHE0") //GHK
END_DEFAULTS
