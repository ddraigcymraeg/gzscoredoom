...
//GHK: COMMENT THIS OUT Extract low order byte
inline unsigned char Byte2(unsigned int ui)
{
...
{
	return ((m_auiS[0][Byte2(ui>>24)] + m_auiS[1][Byte2(ui>>16)]) ^ m_auiS[2][Byte2(ui>>8)]) + m_auiS[3][Byte2(ui)];
}
