...
typedef enum
{
	...
	CF_POWERDAMAGE		= 0x400000, //ghk being used for powerdamage for testing
	CF_SPREAD			= 0x800000, //GHK
	CF_INFINITEAMMO		= 0x1000000, //GHK
} cheat_t;
...
public:
	...
	void SerializeSDHubLvlScore (FArchive &arc); //GHK
	...
	int			wad_score;
	int			barrelcount;
	//int			level_hi_score; //possibly used for MP hi scores
	//int			wad_hi_score;	//possibly used for MP hi scores
