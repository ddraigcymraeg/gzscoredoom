...
//										// not get yerself killed
	...
	DF2_SAME_SPAWN_SPOT		= 1 << 18,	//ghk co-op player respawns back where they died, if not death from environment
	DF2_COOP_WARPTO			= 1 << 19,	//ghk co-op player can warp to another via spycam
	DF2_AGGRESSIVE_BOSSES	= 1 << 20,	//ghk all barons, cybs, spidmasters, and their add-on pack replacements
	DF2_NO_ALTFIRE			= 1 << 21,	//ghk disable alt fire modes
};
...
enum
{
	...
	COMPATF_FORCEBLOCKMONST	= 1 << 17,	//GHK Monsters/Friendlies have any NOBLOCKMONST flags removed
	COMPATF_MEMORIALFIX		= 1 << 18,	//GHK Memorial.wad fix
