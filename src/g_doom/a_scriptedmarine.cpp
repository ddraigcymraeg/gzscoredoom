...
static FRandom pr_m_refireSD ("SMarineRefire");
static FRandom pr_m_punchSD ("SMarinePunch");
static FRandom pr_m_gunshotSD ("SMarineGunshot");
static FRandom pr_m_sawSD ("SMarineSaw");
static FRandom pr_m_fireshotgun2SD ("SMarineFireSSG");

void A_MarineLookSD(AActor *);
void A_MarineNoiseSD (AActor *);
void A_MarineChaseSD (AActor *);
void A_M_RefireSD (AActor *);
void A_M_SawRefireSD (AActor *);
void A_M_SawSD (AActor *);
void A_M_PunchSD (AActor *);
void A_M_BerserkPunchSD (AActor *);
void A_M_FirePistolSD (AActor *);
void A_M_FirePistolInaccurateSD (AActor *);
void A_M_FireShotgunSD (AActor *);
void A_M_CheckAttackSD (AActor *);
void A_M_FireShotgun2SD (AActor *);
void A_M_FireCGunAccurateSD (AActor *);
void A_M_FireCGunSD (AActor *);
void A_M_FireMissileSD (AActor *);
void A_M_FireRailgunSD (AActor *);
void A_M_FirePlasmaSD (AActor *);
void A_M_BFGsoundSD (AActor *);
void A_M_FireBFGSD (AActor *);
...
#define S_MPLAYSTILL 0
	S_NORMAL (PLAY, 'A',	4, A_MarineLookSD 				, &States[S_MPLAYSTILL+1]),
	S_NORMAL (PLAY, 'A',	4, A_MarineNoiseSD 				, &States[S_MPLAYSTILL]),

#define S_MPLAY (S_MPLAYSTILL+2)
	S_NORMAL (PLAY, 'A',	4, A_MarineLookSD 				, &States[S_MPLAY+1]),
	S_NORMAL (PLAY, 'A',	4, A_MarineNoiseSD 				, &States[S_MPLAY+2]),
	S_NORMAL (PLAY, 'A',	4, A_MarineLookSD 				, &States[S_MPLAY+3]),
	S_NORMAL (PLAY, 'B',	4, A_MarineNoiseSD				, &States[S_MPLAY+4]),
	S_NORMAL (PLAY, 'B',	4, A_MarineLookSD					, &States[S_MPLAY+5]),
	S_NORMAL (PLAY, 'B',	4, A_MarineNoiseSD 				, &States[S_MPLAY]),

#define S_MPLAY_RUN (S_MPLAY+6)
	S_NORMAL (PLAY, 'A',	4, A_MarineChaseSD 				, &States[S_MPLAY_RUN+1]),
	S_NORMAL (PLAY, 'B',	4, A_MarineChaseSD 				, &States[S_MPLAY_RUN+2]),
	S_NORMAL (PLAY, 'C',	4, A_MarineChaseSD 				, &States[S_MPLAY_RUN+3]),
	S_NORMAL (PLAY, 'D',	4, A_MarineChaseSD 				, &States[S_MPLAY_RUN+0]),
...
#define S_MPLAY_ATK_CHAINSAW (S_MPLAY_RAISE+6)
	S_NORMAL (PLAY, 'E',	4, A_MarineNoiseSD				, &States[S_MPLAY_ATK_CHAINSAW+1]),
	S_BRIGHT (PLAY, 'F',	4, A_M_SawSD						, &States[S_MPLAY_ATK_CHAINSAW+2]),
	S_BRIGHT (PLAY, 'F',	0, A_M_SawRefireSD				, &States[S_MPLAY_ATK_CHAINSAW+1]),
...
#define S_MPLAY_ATK_FIST (S_MPLAY_ATK_CHAINSAW+4)
	...
	S_NORMAL (PLAY, 'F',	4, A_M_PunchSD					, &States[S_MPLAY_ATK_FIST+2]),	// Purposefully not BRIGHT
	S_NORMAL (PLAY, 'A',	9, NULL							, &States[S_MPLAY_ATK_FIST+3]),
	S_NORMAL (PLAY, 'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_FIST]),
...
#define S_MPLAY_ATK_BERSERK (S_MPLAY_ATK_FIST+5)
	...
	S_NORMAL (PLAY, 'F',	4, A_M_BerserkPunchSD				, &States[S_MPLAY_ATK_BERSERK+2]),	// Purposefully not BRIGHT
	S_NORMAL (PLAY, 'A',	9, NULL							, &States[S_MPLAY_ATK_BERSERK+3]),
	S_NORMAL (PLAY, 'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_BERSERK]),
	S_NORMAL (PLAY, 'A',	5, A_FaceTarget					, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_PISTOL (S_MPLAY_ATK_BERSERK+5)
	S_NORMAL (PLAY, 'E',	4, A_FaceTarget					, &States[S_MPLAY_ATK_PISTOL+1]),
	S_BRIGHT (PLAY, 'F',	6, A_M_FirePistolSD				, &States[S_MPLAY_ATK_PISTOL+2]),
	S_NORMAL (PLAY, 'A',	4, A_FaceTarget					, &States[S_MPLAY_ATK_PISTOL+3]),
	S_NORMAL (PLAY, 'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_PISTOL+5]),
	S_NORMAL (PLAY, 'A',	5, NULL							, &States[S_MPLAY_RUN]),
	S_BRIGHT (PLAY, 'F',	6, A_M_FirePistolInaccurateSD		, &States[S_MPLAY_ATK_PISTOL+6]),
	S_NORMAL (PLAY, 'A',	4, A_FaceTarget					, &States[S_MPLAY_ATK_PISTOL+7]),
	S_NORMAL (PLAY, 'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_PISTOL+5]),
	S_NORMAL (PLAY, 'A',	5, A_FaceTarget					, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_SHOTGUN (S_MPLAY_ATK_PISTOL+9)
	S_NORMAL (PLAY, 'E',	3, A_M_CheckAttackSD				, &States[S_MPLAY_ATK_SHOTGUN+1]),
	S_BRIGHT (PLAY, 'F',	7, A_M_FireShotgunSD				, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_DSHOTGUN (S_MPLAY_ATK_SHOTGUN+2)
	S_NORMAL (PLAY, 'E',	3, A_M_CheckAttackSD				, &States[S_MPLAY_ATK_DSHOTGUN+1]),
	S_BRIGHT (PLAY, 'F',	7, A_M_FireShotgun2SD				, &States[S_MPLAY_RUN]),
...
#define S_MPLAY_ATK_CHAINGUN (S_MPLAY_SKIP_ATTACK+1)
	...
	S_BRIGHT (PLAY, 'F',	4, A_M_FireCGunAccurateSD			, &States[S_MPLAY_ATK_CHAINGUN+2]),
	S_BRIGHT (PLAY, 'F',	4, A_M_FireCGunAccurateSD			, &States[S_MPLAY_ATK_CHAINGUN+3]),
	S_BRIGHT (PLAY, 'F',	4, A_M_FireCGunSD					, &States[S_MPLAY_ATK_CHAINGUN+4]),
	S_BRIGHT (PLAY, 'F',	4, A_M_FireCGunSD					, &States[S_MPLAY_ATK_CHAINGUN+5]),
	S_NORMAL (PLAY,	'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_CHAINGUN+3]),
	S_NORMAL (PLAY, 'A',	0, NULL							, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_ROCKET (S_MPLAY_ATK_CHAINGUN+7)
	S_NORMAL (PLAY, 'E',	8, A_FaceTarget					, &States[S_MPLAY_ATK_ROCKET+1]),
	S_BRIGHT (PLAY, 'F',	6, A_M_FireMissileSD				, &States[S_MPLAY_ATK_ROCKET+2]),
	S_NORMAL (PLAY,	'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_ROCKET]),
	S_NORMAL (PLAY, 'A',	0, NULL							, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_RAILGUN (S_MPLAY_ATK_ROCKET+4)
	S_NORMAL (PLAY, 'E',	4, A_M_CheckAttackSD				, &States[S_MPLAY_ATK_RAILGUN+1]),
	S_BRIGHT (PLAY, 'F',	6, A_M_FireRailgunSD				, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_PLASMA (S_MPLAY_ATK_RAILGUN+2)
	S_NORMAL (PLAY, 'E',	2, A_FaceTarget					, &States[S_MPLAY_ATK_PLASMA+1]),
	S_BRIGHT (PLAY, 'F',	3, A_M_FirePlasmaSD				, &States[S_MPLAY_ATK_PLASMA+2]),
	S_NORMAL (PLAY, 'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_PLASMA+1]),
	S_NORMAL (PLAY, 'A',    0, NULL							, &States[S_MPLAY_RUN]),

#define S_MPLAY_ATK_BFG (S_MPLAY_ATK_PLASMA+4)
	S_NORMAL (PLAY, 'E',	5, A_M_BFGsoundSD					, &States[S_MPLAY_ATK_BFG+1]),
	...
	S_BRIGHT (PLAY, 'F',	6, A_M_FireBFGSD					, &States[S_MPLAY_ATK_BFG+7]),
	S_NORMAL (PLAY, 'A',	4, A_FaceTarget					, &States[S_MPLAY_ATK_BFG+8]),
	S_NORMAL (PLAY, 'A',	0, A_M_RefireSD					, &States[S_MPLAY_ATK_BFG]),
	S_NORMAL (PLAY, 'A',	0, NULL							, &States[S_MPLAY_RUN]),
};
...
void A_M_RefireSD (AActor *self)
{
	if (self->target == NULL || self->target->health <= 0)
	{
		if (self->MissileState && pr_m_refireSD() < 160)
	...
	if ((self->MissileState == NULL && !self->CheckMeleeRange ()) ||
		...
		pr_m_refireSD() < 4)	// Small chance of stopping even when target not dead
	{
		self->SetState (self->state + 1);
	}
}
...
void A_M_SawRefireSD (AActor *self)
{
	if (self->target == NULL || self->target->health <= 0)
	{
		self->SetState (self->state + 1);
...
void A_MarineChaseSD (AActor *self)
{
...
void A_MarineLookSD (AActor *self)
{
	A_MarineNoiseSD (self);
	A_Look (self);
}
...
void A_MarineNoiseSD (AActor *self)
{
	if (self->MeleeState == &AScriptedMarine::States[S_MPLAY_ATK_CHAINSAW])
	{
		S_Sound (self, CHAN_WEAPON, "weapons/sawidle", 1, ATTN_NORM);
...
void A_M_SawSD (AActor *self)
{
	...
	if (self->CheckMeleeRange ())
	{
		...
		damage = 2 * (pr_m_sawSD()%10+1);
		angle = self->angle + (pr_m_sawSD.Random2() << 18);
...
void A_M_PunchSD (AActor *self)
{
	...
	damage = (pr_m_punchSD()%10+1) << 1;

	A_FaceTarget (self);
	angle = self->angle + (pr_m_punchSD.Random2() << 18);
...
void A_M_BerserkPunchSD (AActor *self)
{
	angle_t 	angle;
	int 		damage;
	int 		pitch;
...
void P_GunShot2SD (AActor *mo, bool accurate, int pitch, const PClass *pufftype)
{
	angle_t 	angle;
	int 		damage;
		
	damage = 5*(pr_m_gunshotSD()%3+1);
	angle = mo->angle;

	if (!accurate)
	{
		angle += pr_m_gunshotSD.Random2 () << 18;
	}
...
void A_M_FirePistolSD (AActor *self)
{
	if (self->target == NULL)
		return;
	...
	A_FaceTarget (self);
	P_GunShot2SD (self, true, P_AimLineAttack (self, self->angle, MISSILERANGE),
		PClass::FindClass(NAME_BulletPuff));
}

//============================================================================
//
// A_M_FirePistolInaccurateSD
//
//============================================================================

void A_M_FirePistolInaccurateSD (AActor *self)
{
	if (self->target == NULL)
		return;
	...
	S_Sound (self, CHAN_WEAPON, "weapons/pistol", 1, ATTN_NORM);
	A_FaceTarget (self);
	P_GunShot2SD (self, false, P_AimLineAttack (self, self->angle, MISSILERANGE),
		PClass::FindClass(NAME_BulletPuff));
}
...
void A_M_FireShotgunSD (AActor *self)
{
	int pitch;
	...
	for (int i = 0; i < 7; ++i)
	{
		P_GunShot2SD (self, false, pitch, PClass::FindClass(NAME_BulletPuff));
	}
...
void A_M_CheckAttackSD (AActor *self)
{
...
void A_M_FireShotgun2SD (AActor *self)
{
	int pitch;
	...
	for (int i = 0; i < 20; ++i)
	{
		int damage = 5*(pr_m_fireshotgun2SD()%3+1);
		angle_t angle = self->angle + (pr_m_fireshotgun2SD.Random2() << 19);

		P_LineAttack (self, angle, MISSILERANGE,
					  pitch + (pr_m_fireshotgun2SD.Random2() * 332063), damage,
...
//============================================================================
//
// A_M_FireCGunAccurateSD
//
//============================================================================

void A_M_FireCGunAccurateSD (AActor *self)
{
	if (self->target == NULL)
		return;
...
void A_M_FireCGunSD (AActor *self)
{
	if (self->target == NULL)
		return;
...
void A_M_FireMissileSD (AActor *self)
{
	if (self->target == NULL)
		return;
...
void A_M_FireRailgunSD (AActor *self)
{
	if (self->target == NULL)
		return;
...
void A_M_FirePlasmaSD (AActor *self)
{
	if (self->target == NULL)
		return;
...
void A_M_BFGsoundSD (AActor *self)
{
	if (self->target == NULL)
		return;
...
void A_M_FireBFGSD (AActor *self)
{
	if (self->target == NULL)
		return;
