...
FState AScriptedMarineSD::States[] =
{
...
#define S_MPLAY_DIE (S_MPLAY_PAIN+2)
	...
	S_NORMAL (PLAY, 'M',   -1, NULL							, NULL), //GHK CHANGE FROM N TO M

#define S_MPLAY_XDIE (S_MPLAY_DIE+5) //+5 instead of +7
	...
	S_NORMAL (PLAY, 'V',	5, NULL 						, &States[S_MPLAY_XDIE+8]),
		S_NORMAL (PLAY, 'V',   -1, NULL							, NULL), //GHK change from W to V
...
IMPLEMENT_ACTOR (AScriptedMarineSD, Doom, 9112, 161)
	PROP_SpawnHealth (20) //GHK Change to 20 from 100?
	PROP_RadiusFixed (16)
	PROP_HeightFixed (56)
	PROP_Mass (100)
	PROP_SpeedFixed (8)
	PROP_PainChance (MARINE_PAIN_CHANCE)
	PROP_Flags (MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL) //GHK ADDED MF_COUNTKILL flags for scoring. *May conflict with mods??*
...
void AScriptedMarineSD::Serialize (FArchive &arc)
{
	Super::Serialize (arc);
...
void AScriptedMarineSD::Activate (AActor *activator)
{
...
void AScriptedMarineSD::Deactivate (AActor *activator)
{
	if (!(flags2 & MF2_DORMANT))
	{
		flags2 |= MF2_DORMANT;
...
void AScriptedMarineSD::BeginPlay ()
{
	Super::BeginPlay ();
...
{
	if (self->MeleeState == &AScriptedMarineSD::States[S_MPLAY_ATK_CHAINSAW])
	{
...
void A_M_CheckAttack (AActor *self)
{
	...
	{
		self->SetState (&AScriptedMarineSD::States[S_MPLAY_SKIP_ATTACK]);
	}
	else
	{
		A_FaceTarget (self);
...
class AMarineFistSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineFistSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineFistSD, Doom, 9113, 0)
	PROP_SpawnState (S_MPLAYSTILL)
...
class AMarineBerserkSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineBerserkSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineBerserkSD, Doom, 9114, 0)
	PROP_SpawnState (S_MPLAYSTILL)
...
class AMarineChainsawSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineChainsawSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineChainsawSD, Doom, 9115, 0)
	PROP_SpawnState (S_MPLAYSTILL)
...
class AMarinePistolSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarinePistolSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarinePistolSD, Doom, 9116, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarineShotgunSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineShotgunSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineShotgunSD, Doom, 9117, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarineSSGSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineSSGSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineSSGSD, Doom, 9118, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarineChaingunSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineChaingunSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineChaingunSD, Doom, 9119, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarineRocketSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineRocketSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineRocketSD, Doom, 9120, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarinePlasmaSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarinePlasmaSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarinePlasmaSD, Doom, 9121, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarineRailgunSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineRailgunSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineRailgunSD, Doom, 9122, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
class AMarineBFGSD : public AScriptedMarineSD
{
	DECLARE_STATELESS_ACTOR (AMarineBFGSD, AScriptedMarineSD)
};

IMPLEMENT_STATELESS_ACTOR (AMarineBFGSD, Doom, 9123, 0)
	PROP_SpawnState (S_MPLAYSTILL)
	PROP_MeleeState (255)
...
void AScriptedMarineSD::SetWeapon (EMarineWeapon type)
{
	MissileState = NULL;
	MeleeState = NULL;
	DecalGenerator = NULL;
	...
	case WEAPON_Dummy:
		...
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AScriptedMarineSD))->DecalGenerator;
		break;

	case WEAPON_Fist:
		MeleeState = &States[S_MPLAY_ATK_FIST];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineFistSD))->DecalGenerator;
		break;

	case WEAPON_BerserkFist:
		MeleeState = &States[S_MPLAY_ATK_BERSERK];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineBerserkSD))->DecalGenerator;
		break;

	case WEAPON_Chainsaw:
		MeleeState = &States[S_MPLAY_ATK_CHAINSAW];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineChainsawSD))->DecalGenerator;
		break;

	case WEAPON_Pistol:
		MissileState = &States[S_MPLAY_ATK_PISTOL];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarinePistolSD))->DecalGenerator;
		break;

	case WEAPON_Shotgun:
		MissileState = &States[S_MPLAY_ATK_SHOTGUN];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineShotgunSD))->DecalGenerator;
		break;

	case WEAPON_SuperShotgun:
		MissileState = &States[S_MPLAY_ATK_DSHOTGUN];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineSSGSD))->DecalGenerator;
		break;

	case WEAPON_Chaingun:
		MissileState = &States[S_MPLAY_ATK_CHAINGUN];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineChaingunSD))->DecalGenerator;
		break;

	case WEAPON_RocketLauncher:
		MissileState = &States[S_MPLAY_ATK_ROCKET];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineRocketSD))->DecalGenerator;
		break;

	case WEAPON_PlasmaRifle:
		MissileState = &States[S_MPLAY_ATK_PLASMA];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarinePlasmaSD))->DecalGenerator;
		break;

	case WEAPON_Railgun:
		MissileState = &States[S_MPLAY_ATK_RAILGUN];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineRailgunSD))->DecalGenerator;
		break;

	case WEAPON_BFG:
		MissileState = &States[S_MPLAY_ATK_BFG];
		DecalGenerator = GetDefaultByType (RUNTIME_CLASS(AMarineBFGSD))->DecalGenerator;
		break;
	}
}

void AScriptedMarineSD::SetSprite (const PClass *source)
{
	...
	{ // A valid actor class wasn't passed, so use the standard sprite
		...
		// Copy the standard player's scaling
		AActor * playerdef = GetDefaultByName("DoomPlayer");
		if (playerdef == NULL) playerdef = GetDefaultByType(RUNTIME_CLASS(AScriptedMarineSD));
		scaleX = playerdef->scaleX;
		scaleY = playerdef->scaleY;
	}
	else
