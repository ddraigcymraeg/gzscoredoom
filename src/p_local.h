...
//extern const unsigned char rndtable[256]; //ghk
...
AActor *P_SpawnMissile (AActor* source, AActor* dest, const PClass *type, bool isSDBossRush=false);
AActor *P_SpawnMissileZ (AActor* source, fixed_t z, AActor* dest, const PClass *type);
AActor *P_SpawnMissileXYZ (fixed_t x, fixed_t y, fixed_t z, AActor *source, AActor *dest, const PClass *type, bool isSDBossRush=false);
...
bool	P_CheckMissileSpawn (AActor *missile, bool isSDBossRush=false);
