...
#define MAULATORTICS (50*35) //MAULATORTICS (25*35)
...
IMPLEMENT_STATELESS_ACTOR (AMinotaurFriend, Hexen, -1, 0)
	...
	//PROP_RadiusFixed (20)//ghk added
	//PROP_HeightFixed (56) //ghk added
	PROP_FlagsClear (MF_DROPOFF|MF_COUNTKILL|MF_SOLID) //ghk
	PROP_FlagsSet (MF_FRIENDLY)
	PROP_Flags2Clear (MF2_BOSS)
	PROP_Flags2Set (MF2_TELESTOMP)
	PROP_Flags3Set (MF3_STAYMORPHED|MF3_NOBLOCKMONST) //ghk
