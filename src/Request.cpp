...
// GHK: Used this code for the Online Hi Scoring Communication
// Credit: Adrian Bacaianu
//////////////////////////////////////////////////////////////////////
...
void Request::SendRequest(bool IsPost, LPCSTR url, std::string &psHeaderSend, std::string &psHeaderReceive, std::string &psMessage)
{
    ...
    {													/* POST */
		...
		strcpy(buffer, (LPCTSTR)psHeaderSend.c_str());
