...
struct PClass
{
	...
	mutable PClass		*SDParentClass;	// GHK the class this class derives from due to SD replacements
	...
	static const PClass *GetRandomMonster(const PClass *type, int Rand, fixed_t ix=0, fixed_t iy=0, fixed_t iz=0,bool GetRandomMonster=true); //GHK experimental custom monster spawn
	//GHK for truly static SP custom monster spawning.
	//static unsigned char rndtable2[256];
	//static int rndindex2;
