...
if (i_compatflags & COMPATF_MEMORIALFIX)
  {
    __int64 _x1, _x2, _y1, _y2;

    _x1 = (__int64)x1 - bmaporgx;
    _y1 = (__int64)y1 - bmaporgy;
   ...
   // mapy1 = (int)(_y1>>MAPBTOFRAC);
    ...
    _x2 = (__int64)x2 - bmaporgx;
    _y2 = (__int64)y2 - bmaporgy;
