...
//GHK
void I_SDMessageBox(){
	MessageBox(0, "For Online Hi Scoring, it is recommended that\nyou choose a unique player name and password\n in Options->Player Setup and\n Options->ScoreDoom Setup", "GZScoreDoom Configuration", 0);
}
